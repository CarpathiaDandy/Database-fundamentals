...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(198, 62);
			...
			this->label2->Location = System::Drawing::Point(214, 132);
			...
			this->label3->Location = System::Drawing::Point(217, 202);
			...
			this->wiadomosci->Location = System::Drawing::Point(213, 296);
			...
			// Login
			// 
			this->Login->Location = System::Drawing::Point(153, 159);
			...
			// Haslo
			// 
			this->Haslo->Location = System::Drawing::Point(152, 243);
			...
			// zaloguj_b
			// 
			this->zaloguj_b->Location = System::Drawing::Point(110, 366);
			...
			// powrot
			// 
			this->powrot->Location = System::Drawing::Point(355, 365);
...
private: System::Void zaloguj_b_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	else
	{
		...
		{
			std::string zapytanie = "select Login,Haslo,Czy_Admin from uzytkownicy where Login like '"+Login+"' and Haslo like '" + Haslo + "'";
			...
			if (mysql_query(&mysql, zapytanie.c_str()) == 0)
			{
				...
				if (result)
				{
					...
					{
						string Login=row[0];
						String^ Login2 = msclr::interop::marshal_as<String^>(Login);
						int typ_konta = atoi(row[2]);
						if (typ_konta == 0)
						{
							zalogowany_user^ logowanie = gcnew zalogowany_user(Login2);
						...
						else if (typ_konta == 1)
						{
							...
							zalogowany_admin^ logowanie = gcnew zalogowany_admin(Login2);
			...
			{
				this->wiadomosci->Text = "nie ma takiego konta";
			}
		}
