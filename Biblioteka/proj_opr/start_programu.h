...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(154, 67);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(259, 26);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Witamy w bibliotece nr21";
			this->label1->Click += gcnew System::EventHandler(this, &start_programu::label1_Click);
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(193, 193);
			...
			// zaloguj_but
			// 
			this->zaloguj_but->Location = System::Drawing::Point(185, 349);
			...
			// zarejestruj_but
			// 
			this->zarejestruj_but->Location = System::Drawing::Point(338, 349);
